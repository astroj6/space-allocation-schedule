...
public class RequestFrame extends JFrame {
	...
	JCheckBox nam1 = new JCheckBox("coach");
	JCheckBox nam2 = new JCheckBox("teacher");
	JCheckBox nam3 = new JCheckBox("administration");
	//
	
	//days available
	JCheckBox day1 = new JCheckBox("request Monday ?");
	
	JCheckBox day1_2 = new JCheckBox("request Monday ?");
	
	JCheckBox day1_3 = new JCheckBox("request Monday ?");
	
	JCheckBox day1_4 = new JCheckBox("request Monday ?");
	
	JCheckBox day1_5 = new JCheckBox("request Monday ?");
	  //times available
...
//////////////////////////////////
	...
	public void createComponents() {
		...
		JLabel pls = new JLabel("please determine which rooms need to be requested and navigate to each available room's tab for more specifications , go to the submit tab when you are done.");
		panel.add(pls);
		panel.add(gym);
		panel.add(the);
		panel.add(lab);
		panel.add(caf);
		panel.add(lib);
		JLabel plsn = new JLabel("who are you ?");
		panel.add(plsn);
		panel.add(nam1);
		panel.add(nam2);
		panel.add(nam3);
		...
		JLabel expR1 =new JLabel("please select the semester you'd like to request, afterwards proceed to the tabs for more specifications");
		JLabel expR2 =new JLabel("please select the semester you'd like to request, afterwards proceed to the tabs for more specifications");
		JLabel expR3 =new JLabel("please select the semester you'd like to request, afterwards proceed to the tabs for more specifications");
		JLabel expR4 =new JLabel("please select the semester you'd like to request, afterwards proceed to the tabs for more specifications");
		JLabel expR5 =new JLabel("please select the semester you'd like to request,afterwards proceed to the tabs for more specifications");
		...
		panelR1_intro.add(win);
		 ...
		 JLabel expR1_2 =new JLabel("select which days are requested and then navigate to their respective tabs to select the requested time slots");
		 JLabel expR1_22 =new JLabel("select which days are requested and then navigate to their respective tabs to select the requested time slots");
		 JLabel expR1_23 =new JLabel("select which days are requested and then navigate to their respective tabs to select the requested time slots");
		 JLabel expR1_24 =new JLabel("select which days are requested and then navigate to their respective tabs to select the requested time slots");
		 JLabel expR1_25 =new JLabel("select which days are requested and then navigate to their respective tabs to select the requested time slots");
...
if(!(Sch.getR1().getD1().getAv())) {
	day1.setEnabled(false);
}
if(!(Sch.getR1().getD2().getAv())) {
	day2.setEnabled(false);
}
if(!(Sch.getR1().getD3().getAv())) {
	day3.setEnabled(false);
}
if(!(Sch.getR1().getD4().getAv())) {
	day4.setEnabled(false);
}
if(!(Sch.getR1().getD5().getAv())) {
	day5.setEnabled(false);
}
if(!(Sch.getR1().getD1().getT1())) {
	mtime1.setEnabled(false);
	
}
if(!(Sch.getR1().getD1().getT2())) {
	mtime2.setEnabled(false);
	
}
if(!(Sch.getR1().getD1().getT3())) {
	mtime3.setEnabled(false);
	
}
if(!(Sch.getR1().getD1().getT4())) {
	mtime4.setEnabled(false);
	
}
if(!(Sch.getR1().getD1().getT5())) {
	mtime5.setEnabled(false);
	
}

if(!(Sch.getR1().getD2().getT1())) {
	ttime1.setEnabled(false);
	
}
if(!(Sch.getR1().getD2().getT2())) {
	ttime2.setEnabled(false);
	
}
if(!(Sch.getR1().getD2().getT3())) {
	ttime3.setEnabled(false);
	
}
if(!(Sch.getR1().getD2().getT4())) {
	ttime4.setEnabled(false);
	
}
if(!(Sch.getR1().getD2().getT5())) {
	ttime5.setEnabled(false);
	
}

if(!(Sch.getR1().getD3().getT1())) {
	wtime1.setEnabled(false);
	
}
if(!(Sch.getR1().getD3().getT2())) {
	wtime2.setEnabled(false);
	
}
if(!(Sch.getR1().getD3().getT3())) {
	wtime3.setEnabled(false);
	
}
if(!(Sch.getR1().getD3().getT4())) {
	wtime4.setEnabled(false);
	
}
if(!(Sch.getR1().getD3().getT5())) {
	wtime5.setEnabled(false);
	
}

if(!(Sch.getR1().getD4().getT1())) {
	htime1.setEnabled(false);
	
}
if(!(Sch.getR1().getD4().getT2())) {
	htime2.setEnabled(false);
	
}
if(!(Sch.getR1().getD4().getT3())) {
	htime3.setEnabled(false);
	
}
if(!(Sch.getR1().getD4().getT4())) {
	htime4.setEnabled(false);
	
}
if(!(Sch.getR1().getD4().getT5())) {
	htime5.setEnabled(false);
	
}

if(!(Sch.getR1().getD5().getT1())) {
	ftime1.setEnabled(false);
	
}
if(!(Sch.getR1().getD5().getT2())) {
	ftime2.setEnabled(false);
	
}
if(!(Sch.getR1().getD5().getT3())) {
	ftime3.setEnabled(false);
	
}
if(!(Sch.getR1().getD5().getT4())) {
	ftime4.setEnabled(false);
	
}
if(!(Sch.getR1().getD5().getT5())) {
	ftime5.setEnabled(false);
...
if(!(Sch.getR2().getF())) {
	fal2.setEnabled(false);
}

if(!(Sch.getR2().getW())) {
	win2.setEnabled(false);
}

if(!(Sch.getR2().getD1().getAv())) {
	day1_2.setEnabled(false);
}
if(!(Sch.getR2().getD2().getAv())) {
	day2_2.setEnabled(false);
}
if(!(Sch.getR2().getD3().getAv())) {
	day3_2.setEnabled(false);
}
if(!(Sch.getR2().getD4().getAv())) {
	day4_2.setEnabled(false);
}
if(!(Sch.getR2().getD5().getAv())) {
	day5_2.setEnabled(false);
}
if(!(Sch.getR2().getD1().getT1())) {
	mtime1_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD1().getT2())) {
	mtime2_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD1().getT3())) {
	mtime3_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD1().getT4())) {
	mtime4_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD1().getT5())) {
	mtime5_2.setEnabled(false);
	
}

if(!(Sch.getR2().getD2().getT1())) {
	ttime1_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD2().getT2())) {
	ttime2_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD2().getT3())) {
	ttime3_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD2().getT4())) {
	ttime4_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD2().getT5())) {
	ttime5_2.setEnabled(false);
	
}

if(!(Sch.getR2().getD3().getT1())) {
	wtime1_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD3().getT2())) {
	wtime2_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD3().getT3())) {
	wtime3_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD3().getT4())) {
	wtime4_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD3().getT5())) {
	wtime5_2.setEnabled(false);
	
}

if(!(Sch.getR2().getD4().getT1())) {
	htime1_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD4().getT2())) {
	htime2_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD4().getT3())) {
	htime3_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD4().getT4())) {
	htime4_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD4().getT5())) {
	htime5_2.setEnabled(false);
	
}

if(!(Sch.getR2().getD5().getT1())) {
	ftime1_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD5().getT2())) {
	ftime2_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD5().getT3())) {
	ftime3_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD5().getT4())) {
	ftime4_2.setEnabled(false);
	
}
if(!(Sch.getR2().getD5().getT5())) {
	ftime5_2.setEnabled(false);
...
if(!(Sch.getR3().getF())) {
	fal3.setEnabled(false);
}

if(!(Sch.getR3().getW())) {
	win3.setEnabled(false);
}

if(!(Sch.getR3().getD1().getAv())) {
	day1_3.setEnabled(false);
}
if(!(Sch.getR3().getD2().getAv())) {
	day2_3.setEnabled(false);
}
if(!(Sch.getR3().getD3().getAv())) {
	day3_3.setEnabled(false);
}
if(!(Sch.getR3().getD4().getAv())) {
	day4_3.setEnabled(false);
}
if(!(Sch.getR3().getD5().getAv())) {
	day5_3.setEnabled(false);
}
if(!(Sch.getR3().getD1().getT1())) {
	mtime1_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD1().getT2())) {
	mtime2_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD1().getT3())) {
	mtime3_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD1().getT4())) {
	mtime4_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD1().getT5())) {
	mtime5_3.setEnabled(false);
	
}

if(!(Sch.getR3().getD2().getT1())) {
	ttime1_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD2().getT2())) {
	ttime2_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD2().getT3())) {
	ttime3_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD2().getT4())) {
	ttime4_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD2().getT5())) {
	ttime5_3.setEnabled(false);
	
}

if(!(Sch.getR3().getD3().getT1())) {
	wtime1_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD3().getT2())) {
	wtime2_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD3().getT3())) {
	wtime3_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD3().getT4())) {
	wtime4_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD3().getT5())) {
	wtime5_3.setEnabled(false);
	
}

if(!(Sch.getR3().getD4().getT1())) {
	htime1_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD4().getT2())) {
	htime2_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD4().getT3())) {
	htime3_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD4().getT4())) {
	htime4_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD4().getT5())) {
	htime5_3.setEnabled(false);
	
}

if(!(Sch.getR3().getD5().getT1())) {
	ftime1_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD5().getT2())) {
	ftime2_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD5().getT3())) {
	ftime3_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD5().getT4())) {
	ftime4_3.setEnabled(false);
	
}
if(!(Sch.getR3().getD5().getT5())) {
	ftime5_3.setEnabled(false);
...
if(!(Sch.getR4().getD1().getAv())) {
	day1_4.setEnabled(false);
}
if(!(Sch.getR4().getD2().getAv())) {
	day2_4.setEnabled(false);
}
if(!(Sch.getR4().getD3().getAv())) {
	day3_4.setEnabled(false);
}
if(!(Sch.getR4().getD4().getAv())) {
	day4_4.setEnabled(false);
}
if(!(Sch.getR4().getD5().getAv())) {
	day5_4.setEnabled(false);
}
if(!(Sch.getR4().getD1().getT1())) {
	mtime1_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD1().getT2())) {
	mtime2_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD1().getT3())) {
	mtime3_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD1().getT4())) {
	mtime4_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD1().getT5())) {
	mtime5_4.setEnabled(false);
	
}

if(!(Sch.getR4().getD2().getT1())) {
	ttime1_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD2().getT2())) {
	ttime2_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD2().getT3())) {
	ttime3_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD2().getT4())) {
	ttime4_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD2().getT5())) {
	ttime5_4.setEnabled(false);
	
}

if(!(Sch.getR4().getD3().getT1())) {
	wtime1_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD3().getT2())) {
	wtime2_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD3().getT3())) {
	wtime3_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD3().getT4())) {
	wtime4_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD3().getT5())) {
	wtime5_4.setEnabled(false);
	
}

if(!(Sch.getR4().getD4().getT1())) {
	htime1_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD4().getT2())) {
	htime2_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD4().getT3())) {
	htime3_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD4().getT4())) {
	htime4_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD4().getT5())) {
	htime5_4.setEnabled(false);
	
}

if(!(Sch.getR4().getD5().getT1())) {
	ftime1_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD5().getT2())) {
	ftime2_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD5().getT3())) {
	ftime3_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD5().getT4())) {
	ftime4_4.setEnabled(false);
	
}
if(!(Sch.getR4().getD5().getT5())) {
	ftime5_4.setEnabled(false);
...
if(!(Sch.getR5().getD1().getAv())) {
	day1_5.setEnabled(false);
}
if(!(Sch.getR5().getD2().getAv())) {
	day2_5.setEnabled(false);
}
if(!(Sch.getR5().getD3().getAv())) {
	day3_5.setEnabled(false);
}
if(!(Sch.getR5().getD4().getAv())) {
	day4_5.setEnabled(false);
}
if(!(Sch.getR5().getD5().getAv())) {
	day5_5.setEnabled(false);
}
if(!(Sch.getR5().getD1().getT1())) {
	mtime1_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD1().getT2())) {
	mtime2_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD1().getT3())) {
	mtime3_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD1().getT4())) {
	mtime4_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD1().getT5())) {
	mtime5_5.setEnabled(false);
	
}

if(!(Sch.getR5().getD2().getT1())) {
	ttime1_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD2().getT2())) {
	ttime2_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD2().getT3())) {
	ttime3_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD2().getT4())) {
	ttime4_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD2().getT5())) {
	ttime5_5.setEnabled(false);
	
}

if(!(Sch.getR5().getD3().getT1())) {
	wtime1_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD3().getT2())) {
	wtime2_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD3().getT3())) {
	wtime3_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD3().getT4())) {
	wtime4_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD3().getT5())) {
	wtime5_5.setEnabled(false);
	
}

if(!(Sch.getR5().getD4().getT1())) {
	htime1_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD4().getT2())) {
	htime2_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD4().getT3())) {
	htime3_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD4().getT4())) {
	htime4_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD4().getT5())) {
	htime5_5.setEnabled(false);
	
}

if(!(Sch.getR5().getD5().getT1())) {
	ftime1_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD5().getT2())) {
	ftime2_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD5().getT3())) {
	ftime3_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD5().getT4())) {
	ftime4_5.setEnabled(false);
	
}
if(!(Sch.getR5().getD5().getT5())) {
	ftime5_5.setEnabled(false);
